...
\end{itemize}
  ...
  \section{Tao Lu}
   ...
   \begin{enumerate}
     ...
     \item If isn't, for example, we want the $\rho$ of a line, but we have $\rho$ in a volumn, then find the $\rho$ we want. We can multiply the $\rho_v$ by $S$ to obtain the $\rho_L$
   \end{enumerate}
   ...
   \begin{enumerate}
     \item Find $\alpha$
     \item Calculate $20log_{10}(exp(\alpha\times x))$, where x has the unit of meter.
   \end{enumerate}
